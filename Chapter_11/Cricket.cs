...
{
    class Cricket : SportingTeams
    {
        protected const int teamSize = 11;
        const double winReward = 21;
        const double lossPenalty = 7;
        ...
        public List<int> jerseyNo = new List<int> { 1, 18, 6, 3, 43, 73, 34, 11, 23, 15, 2, 5, 10 };
        ...
        public override string ToString()
        {
            ...
            retval.Append("Sport Type:").Append('\t').Append(nameof(Cricket));
            retval.Append(Environment.NewLine);
            retval.Append("Team Coach:").Append('\t').Append(this.Coach);
            retval.Append(Environment.NewLine);

            retval.Append(Environment.NewLine);
            retval.Append("Player").Append('\t').Append('\t').Append("Jersey No.");
